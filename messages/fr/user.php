...
return array (
  '#' => '',
  'Are you sure you want to switch to this user for the rest of this Session?' => 'Êtes-vous sûr de vouloir switcher à cet utilisateur pour le reste de cette session ?',
  ...
  'Error while trying to generate new password' => 'Erreur lors de la tentative de génération du mot de passe',
  'Generate and send new password to user' => 'Générer et envoyer un nouveau mot de passe à l\'utilisateur',
  'Impersonate user is disabled in the application configuration' => 'L\'emprunt d\'identité est désactivé dans la configuration de l\'application',
  ...
  'Your password on {0} has been changed' => 'Votre mot de passe sur {0} a été modifié',
  '(not set)' => '(non défini)',
